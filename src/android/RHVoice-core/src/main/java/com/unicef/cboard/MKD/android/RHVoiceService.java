...
import com.unicef.cboard.MKD.*;
import com.unicef.cboard.MKD.LanguageInfo;
...
public final class RHVoiceService extends TextToSpeechService implements LifecycleOwner {
    public static final String KEY_PARAM_TEST_VOICE = "com.unicef.cboard.MKD.android.param_test_voice";
    ...
    public static final String ACTION_CHECK_DATA = "com.unicef.cboard.MKD.android.action.service_check_data";
